/*
 * From the HDRP Unity Template
 * License: https://unity3d.com/de/legal/licenses/Unity_Companion_License
 */
...
{
    public class DefaultUnityCameraController : MonoBehaviour
    {
        class CameraState
        {
            public float yaw;
